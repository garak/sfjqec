...
abstract class BaseCategoryPeer
{
  ...
  private static $fieldNames = array (
    BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'CreatedAt', 'UpdatedAt', 'Slug', ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'createdAt', 'updatedAt', 'slug', ),
    BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CREATED_AT, self::UPDATED_AT, self::SLUG, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CREATED_AT', 'UPDATED_AT', 'SLUG', ),
    BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'created_at', 'updated_at', 'slug', ),
  ...
  private static $fieldKeys = array (
    BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'Slug' => 4, ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'slug' => 4, ),
    BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, self::SLUG => 4, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, 'SLUG' => 4, ),
    BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, 'slug' => 4, ),
    BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
  );
  ...
  protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
  {
    ...
    foreach ($objects as $obj)
    {
      ...
      $criteria->add(ProductPeer::CATEGORY_ID, $obj->getId());
