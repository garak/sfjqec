...
abstract class BaseProductPeer
{
  ...
  private static $fieldNames = array (
    BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'CategoryId', 'Price', 'CreatedAt', 'UpdatedAt', 'Slug', ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'categoryId', 'price', 'createdAt', 'updatedAt', 'slug', ),
    BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CATEGORY_ID, self::PRICE, self::CREATED_AT, self::UPDATED_AT, self::SLUG, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CATEGORY_ID', 'PRICE', 'CREATED_AT', 'UPDATED_AT', 'SLUG', ),
    BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'category_id', 'price', 'created_at', 'updated_at', 'slug', ),
  ...
  private static $fieldKeys = array (
    BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'CategoryId' => 2, 'Price' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, 'Slug' => 6, ),
    BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'categoryId' => 2, 'price' => 3, 'createdAt' => 4, 'updatedAt' => 5, 'slug' => 6, ),
    BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CATEGORY_ID => 2, self::PRICE => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, self::SLUG => 6, ),
    BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CATEGORY_ID' => 2, 'PRICE' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, 'SLUG' => 6, ),
    BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'category_id' => 2, 'price' => 3, 'created_at' => 4, 'updated_at' => 5, 'slug' => 6, ),
    BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
  );
  ...
  public static function addSelectColumns(Criteria $criteria, $alias = null)
  {
    if (null === $alias)
    {
      ...
      $criteria->addSelectColumn(ProductPeer::SLUG);
    }
    else
    {
